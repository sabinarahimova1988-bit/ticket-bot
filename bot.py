...
ВАЖНО: Если пользователь пишет только имя пассажира и комиссии (например "Salamov 25 наши 5 агента" или "Ramazanov cu 15 ca 5 компания Evrascon") — это ВСЕГДА update, НЕ add. Не добавляй новый билет, только обнови поля существующего.
Пример: "Salamov Savkhan sco bak 25 наши, 5 агента" -> {"action":"update","name":"Salamov Savkhan","route":"Sco-Bak","fields":{"cu":25,"ca":5}}
Пример: "Ramazanov наша комиссия 15, агенту 5, компания Evrascon" -> {"action":"update","name":"Ramazanov","route":"","fields":{"cu":15,"ca":5,"company":"Evrascon"}}
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"{email_status} (проверяю каждые 15 мин)\n\n"
        "Отправьте мне:\n"
